...
ScienceQuestions = { 'What kind of rocks form inside of volcanoes?': ['metamorphic', 'sedimentary', 'igneous', 'daffodils', 'Igneous rocks form when lava cools downs.', 'Correct!'], 'What is the term given to baby frogs before they gain their legs?': ['Baby frogs', 'little green things', 'snakes', 'tadpoles', 'Aw man, the correct answer is tadpoles.', 'Neat-oh!'], 'What kind of rock forms after experiencing intense heat and pressure?': ['sedimentary', 'metamorphic', 'igneous', 'daffodils', 'Metamorphic is the correct answer', 'Nice one!'], 'What is the name of all the parts of our body that help digest food?': ['The digestion system', 'The heart', 'The feet', 'The skeleton', 'The digestion system is the name for all the parts of our body that work together to help digest food!', 'Nice one, smarty!'], 
